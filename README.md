...
Caso deseje executar o código. Será necessário possuir um microcontrolador de sua preferência, ou um simulador, mudar as estradas de acordo com o seu dispositivo, ter um IDL compativel com o MicroPython como o "Thonny" para poder salvar o código no microcontrolador, e também para Python 3 como o "PyCharm". A parte do circuito pode ser montada da forma que achar melhor.
